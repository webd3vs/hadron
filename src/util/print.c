...
void util_typelog(Typed *v) {
  switch (v->type) {
    case PROGRAM:
      printf("\x1b[95mProgram\x1b[m { \x1b[94m...\x1b[m }\n");
      break;
    case IMPORT_DECLARATION:
      printf("\x1b[95mImportDeclaration\x1b[m { \x1b[94m...\x1b[m }\n");
      break;
    case IMPORT_SPECIFIER:
      printf("\x1b[95mImportSpecifier\x1b[m { \x1b[94m...\x1b[m }\n");
      break;
    case ASSIGNMENT_EXPRESSION:
      printf("\x1b[95mAssignmentExpression\x1b[m { \x1b[94m...\x1b[m }\n");
      break;
    case EXPRESSION_STATEMENT:
      printf("\x1b[95mExpressionStatement\x1b[m { \x1b[94m...\x1b[m }\n");
      break;
    case RETURN_STATEMENT:
      printf("\x1b[95mReturnStatement\x1b[m { \x1b[94m...\x1b[m }\n");
      break;
    case CASE_STATEMENT:
      printf("\x1b[95mCaseStatement\x1b[m { \x1b[94m...\x1b[m }\n");
      break;
    case LITERAL:
      printf("\x1b[93m%s\x1b[m\n", ((Literal *)v)->value);
      break;
    case CALL_EXPRESSION:
      printf("\x1b[95mCallExpression\x1b[m { \x1b[94m...\x1b[m }\n");
      break;
    default:
      break;
  }
...
void util_linelog(Typed *v) {
  switch (v->type) {
    ...
    case IDENTIFIER: {
      ...
      printf("\x1b[94;3m%s\x1b[m\n", id->name);
      break;
    }
    case TYPED_IDENTIFIER: {
      TypedIdentifier *id = (TypedIdentifier *)v;
      printf("\x1b[94;3m%s\x1b[m <\x1b[34;1m%s\x1b[m>\n", id->name, id->kind);
      break;
    }
    default:
      printf("\x1b[93mnull\x1b[m\n");
      break;
  }
}
...
void util_log(Typed *v, int indent, int depth) {
  ...
  // if (!v) printf("\x1b[93m(null)\x1b[m\n");
  switch (v->type) {
    case EXPRESSION_STATEMENT: {
      printf("\x1b[95mExpressionStatement\x1b[m {\n");
    ...
    case RETURN_STATEMENT: {
      printf("\x1b[95mReturnStatement\x1b[m {\n");
    ...
    case SWITCH_STATEMENT: {
      printf("\x1b[95mSwitchStatement\x1b[m {\n");
      SwitchStatement *stmt = (SwitchStatement *)v;
      tab(indent + 1);
      printf("\x1b[96mexpr\x1b[m: ");
      util_log((Typed *)stmt->expr, indent + 1, depth);
      tab(indent);
      printf("}\n");
      break;
    }
    case CASE_STATEMENT: {
      ...
      printf("\x1b[95mCaseStatement\x1b[m {\n");
      tab(indent + 1);
      printf("\x1b[96mexpr\x1b[m: ");
      util_log((Typed *)stmt->test, indent + 1, depth);
      for (int i = 0; i < stmt->body->length; i++) {
        tab(indent + 1);
        util_log(stmt->body->array[i], indent + 1, depth);
      };
      tab(indent);
      printf("}\n");
      break;
    ...
    case DEFAULT_STATEMENT: {
      ...
      printf("\x1b[95mDefaultStatement\x1b[m {\n");
      for (int i = 0; i < stmt->body->length; i++) {
        tab(indent + 1);
        util_log(stmt->body->array[i], indent + 1, depth);
      };
    ...
    case FOR_STATEMENT: {
      printf("\x1b[95mForStatement\x1b[m {\n");
      ForStatement *stmt = (ForStatement *)v;
      tab(indent + 1);
      printf("\x1b[96minit\x1b[m: ");
      util_log((Typed *)stmt->init, indent + 1, depth);
      tab(indent + 1);
      printf("\x1b[96mtest\x1b[m: ");
      util_log((Typed *)stmt->test, indent + 1, depth);
      tab(indent + 1);
      printf("\x1b[96mupdate\x1b[m: ");
      util_log((Typed *)stmt->update, indent + 1, depth);
      if (stmt->body)
        for (int i = 0; i < stmt->body->length; i++) {
          tab(indent + 1);
          util_log(stmt->body->array[i], indent + 1, depth);
    ...
    case WHILE_STATEMENT: {
      printf("\x1b[95mWhileStatement\x1b[m {\n");
    ...
    case BINARY_EXPRESSION: {
      ...
      printf("\x1b[95mBinaryExpression\x1b[m<\x1b[92m%s\x1b[m> {\n",
        getBinaryOperator(expr->oper));
      tab(indent + 1);
      printf("\x1b[96mleft\x1b[m: ");
      util_log((Typed *)expr->left, indent + 1, depth);
      tab(indent + 1);
      printf("\x1b[96mright\x1b[m: ");
    ...
    case UNARY_EXPRESSION: {
      ...
      printf("\x1b[95mUnaryExpression\x1b[m<\x1b[92m%s\x1b[m> {\n",
        getUnaryOperator(expr->oper));
      tab(indent + 1);
      printf("\x1b[96mexpr\x1b[m: ");
      util_log((Typed *)expr->expr, indent + 1, depth);
      tab(indent);
      printf("}\n");
      break;
    }
    ...
    case IMPORT_DECLARATION: {
      printf("\x1b[95mImportDeclaration\x1b[m {\n");
      ImportDeclaration *decl = (ImportDeclaration *)v;
      tab(indent + 1);
      printf("\x1b[96msource\x1b[m: ");
      util_linelog((Typed *)decl->source);
      for (int i = 0; i < decl->specifiers->length; i++) {
        util_log(decl->specifiers->array[i], indent + 1, depth);
      };
      tab(indent);
      printf("}\n");
      break;
    ...
    case FUNCTION_DECLARATION: {
      ...
      printf("%s\x1b[95mFunctionDeclaration\x1b[m {\n",
        decl->async ? "\x1b[95;4mAsync\x1b[m" : "");
      tab(indent + 1);
      printf("\x1b[96mname\x1b[m: ");
      util_linelog((Typed *)decl->name);
      if (decl->params)
        for (int i = 0; i < decl->params->length; i++) {
          tab(indent + 1);
          printf("- ");
          util_linelog((Typed *)decl->params->array[i]);
        }
      if (decl->body)
        for (int i = 0; i < decl->body->length; i++) {
          tab(indent + 1);
          util_log(decl->body->array[i], indent + 1, depth);
        };
      tab(indent);
      printf("}\n");
      break;
    ...
    case ASSIGNMENT_EXPRESSION: {
      printf("\x1b[95mAssignmentExpression\x1b[m {\n");
...
void codeError(Error *e) {
  ...
  if (errlen < w->ws_col) {
    ...
    printf("┬─%s%s%s %s %s%s─%s%s %s%s:%s%i%s:%s%i %s%s─%s%s %s %s%s",
      ...
      yellow, e->token->pos.line, clear, yellow, e->token->pos.start, clear,
...
void printErrors(Array *array) {
  for (int i = 0; i < array->length; i++) {
    switch (((ErrorLike *)array->array[i])->type) {
      case CLIERROR: {
        CLIError *error = (CLIError *)array->array[i];
        printf("\x1b[1;7;91m CLIError \x1b[0;91m %s\x1b[m\n", error->data);
        break;
      }
      case ERROR: {
        Error *error = (Error *)array->array[i];
        codeError(error);
        break;
      }
    }
...
void debug_log(char *function_name, char *code, Token *token) {
  printf("\x1b[96m%11s\x1b[m: entering function with token "
         "\x1b[92m%5s\x1b[m type \x1b[93m%2i\x1b[m\n",
